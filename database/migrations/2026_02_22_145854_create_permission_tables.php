...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        /**
         * NOTE: roles table is created by create_roles_table migration
         * See 2026_02_22_145922_create_roles_table.php
         */
        ...
        Schema::create($tableNames['role_has_permissions'], static function (Blueprint $table) use ($tableNames, $pivotRole, $pivotPermission) {
            ...
            $table->primary([$pivotRole, $pivotPermission], 'role_has_permissions_role_permission_primary');
        });
    }
